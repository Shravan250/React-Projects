...
function App() {
  ...
  const convert = () => {
    const roundedAmount = (amount * currencyInfo[to]).toFixed(2);
  ...
  return (
    <>
      ...
      >
        <div className="w-fit">
          <div className="w-full maxw-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
            <form
              onSubmit={(e) => {
                e.preventDefault();
                convert();
